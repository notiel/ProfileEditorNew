...
def check_min_max_parameter(data: Dict[str, Any], param: str, lower: int, upper: int) -> str:
    ...
    if not min_value or not max_value:
        ...
        if not isinstance(min_value, int) or min_value < lower or not isinstance(max_value, int) \
                or max_value < min_value or max_value > upper:
...
def check_keys(data: Dict[str, Any], key_list: List[str]) -> Tuple[str, List[str]]:
    """
